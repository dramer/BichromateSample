...
public class sTestLinkObject extends sTestBaseObjectType {
	 ...
	 * <br>  
	 * @return boolean - true if click was succeful
	 * @author dramer
	 * @version 3.0
	 */
	public boolean clicksTestLinkObject() {
		...
		try{
			...
			if(null != element){
				...
				myPOMLogger.enterSevereLog(pageObjectName +" : clicksTestLinkObject element not found ");
			}
		}catch (Exception e){
			myPOMLogger.enterSevereLog(pageObjectName +" : clicksTestLinkObject element not found ");
		}
		return false;
	}//clicksTestLinkObject
