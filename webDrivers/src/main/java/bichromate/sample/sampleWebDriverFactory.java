...
import bichromate.sample.pageDeclaration.samplePageDeclaration;
import bichromate.sample.pageDeclaration.sampleTablePageDeclaration;

public class sampleWebDriverFactory extends sTestWebDriverFactory{

	private samplePageDeclaration spd = null;
	private sampleTablePageDeclaration std = null;
	...
	public sampleTablePageDeclaration getSampleTablePageDeclaration(){
		if(null == std){
			std = new sampleTablePageDeclaration(driver);
		}
		return std;
	...
	public RemoteWebDriver createWebDriver(String remote, String version,
		...
		return (super.createBrowserWebDriver(remote, version, platform, "7",browser,
				setupString));
	}
}
