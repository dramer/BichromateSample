...
public class Recorder {
	...
	/**
	 * @param movFile - path and file name of the movie to store
	 * @throws MalformedURLException - URL not formatted correctly
	 * 
	 */
	...
	/**
	 * @param args - input params not used
	 * @throws Exception - File creation exception
	 */
